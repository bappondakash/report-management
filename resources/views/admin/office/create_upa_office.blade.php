        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">নতুন উপজেলা অফিস</li>
                </ol>
            </div>
            <h4 class="page-title">নতুন উপজেলা অফিস</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card">
            <div class="card-header bg-success py-3 text-white">
                <h5 class="card-title mb-0 text-white">নতুন উপজেলা অফিস</h5>
            </div>
            <div id="cardCollpase7" class="collapse show">
                <div class="card-body">
                    <div class="container">
                        <form action="{{ route('admin.upazila-offices.store') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" value="upa_" name="office_code">
                                </div>
