        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">উপজেলা অফিসসমূহ</li>
                </ol>
            </div>
            <h4 class="page-title">উপজেলা অফিসসমূহ</h4>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header bg-success py-3 text-white">
                <h5 class="card-title mb-0 text-white">উপজেলা অফিসসমূহ</h5>
            </div>
                    ...
                    <div class="card-body">
                        <div class="table-responsive text-center">
                            <table class="table table-bordered table-nowrap table-hover table-centered m-0">
                                ...
                                <tbody>
                                @foreach($upa_office as $key=>$data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/upazila-offices/'.$data->id.'/edit') }}" class="btn btn-xs btn-light"><i class="mdi mdi-pencil"></i></a> |
                                            <a href="{{ url('admin/upazila-offices/'.$data->id.'/delete') }}" class="btn btn-xs btn-light"><i class="mdi mdi-delete"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
