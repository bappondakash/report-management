        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">বিভাগীয় অফিসসমূহ</li>
                </ol>
            </div>
            <h4 class="page-title">বিভাগীয় অফিসসমূহ</h4>
        </div>
    </div>
</div>
                            ...
                            <table class="table table-bordered table-nowrap table-hover table-centered m-0">
                                ...
                                @foreach($divoffice as $key=>$data)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('admin/divisional-offices/'.$data->id.'/edit') }}" class="btn btn-xs btn-light"><i class="mdi mdi-pencil"></i></a> |
                                            <a href="{{ url('admin/divisional-offices/'.$data->id.'/delete') }}" class="btn btn-xs btn-light"><i class="mdi mdi-delete"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
